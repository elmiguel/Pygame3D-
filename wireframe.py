...
def rotateAboutVector(v1,v2, radians):
...
class Wireframe:
    ...
    def outputFaces(self):
        ...
        for i, nodes in enumerate(self.faces):
            #update: py3.x will not execute multi lists and tuples
            #output: ((0, 1, 3, 2), array([255, 255, 255], dtype=uint8))
            #output: 0: (0, 1, 3, 2)
            #Changing join method to join nodes[0]
